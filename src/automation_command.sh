...
if [[ -z "$skipAuphonic" ]]; then
    episodePreset=$(op item get --vault Podcast "Auphonic Api" --fields label=episodePreset) 
    youtubePreset=$(op item get --vault Podcast "Auphonic Api" --fields label=youtubePreset) 
